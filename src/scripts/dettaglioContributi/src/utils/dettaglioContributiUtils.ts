...
const mergeDettaglioContributi = (dc1: DettaglioContributoCumulato, dc2: DettaglioContributoCumulato): DettaglioContributoCumulato => {
    return {
        ...
        commissioniCumulate: dc1.commissioniCumulate > dc2.commissioniCumulate ? dc1.commissioniCumulate : dc2.commissioniCumulate,
        dataCompetenza: dc1.dataCompetenza,
        dataValuta: dc1.dataValuta,
        importo: dc1.importo + dc2.importo,
        importoCumulato: dc1.importoCumulato > dc2.importoCumulato ? dc1.importoCumulato : dc2.importoCumulato,
        linea: dc1.linea,
        numeroQuote: dc1.numeroQuote + dc2.numeroQuote,
        numeroQuoteCumulate: dc1.numeroQuoteCumulate > dc2.numeroQuoteCumulate ? dc1.numeroQuoteCumulate : dc2.numeroQuoteCumulate,
